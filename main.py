...
st.title('Traffic Lights Detector')
...
if img_file is not None:
    ...
    with open(os.path.join('uploads','img_1.jpg'),'wb') as f:
        f.write(img_file.getbuffer())
    PATH_TO_TEST_IMAGES_DIR = './uploads'
    MODEL_NAME = 'faster_rcnn_resnet101_coco_11_06_2017'

    commands = detect_traffic_lights(PATH_TO_TEST_IMAGES_DIR, MODEL_NAME, 1, plot_flag=False)
    print(commands)
